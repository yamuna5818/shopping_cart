...
- Trying to fix [#33](https://github.com/SrBrahma/GitHub-Repository-Manager/issues/33) by setting specific dependencies version. Strangely, this error doesn't happen on dev.
